...
/*	dodgeball	*/
MACRO_CONFIG_INT(SvdbBallVelocity, sv_db_ball_velocity, 300, 10, 3000, CFGFLAG_SERVER, "Velocity of the ball after it got shot (value/10.0 (default=300)).")
...
MACRO_CONFIG_INT(SvdbBallRadius, sv_db_ball_radius, 14, 0, 1000, CFGFLAG_SERVER, "Flag hookable radius (default=14)")
